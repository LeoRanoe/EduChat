...
OPENAI_API_KEY=sk-...  # Required for AI chat functionality
SESSION_SECRET=[Auto-generated by Render]
```

#### Optional Variables:
```bash
PYTHON_VERSION=3.11  # Defaults to 3.11
APP_ENV=production
DEBUG=False
```

> **Note:** Replace `[YOUR_PROJECT]` and `[YOUR_PASSWORD]` with your actual Supabase credentials.
...
| `DATABASE_URL` | `postgresql://postgres:...` | Your Supabase Postgres connection string |
| `SUPABASE_URL` | `https://xxx.supabase.co` | Your Supabase project URL |
| `SUPABASE_ANON_KEY` | `eyJh...` | Your Supabase anon key |
| `SUPABASE_SERVICE_ROLE_KEY` | `eyJh...` | Your Supabase service role key (keep secret!) |
...
- Test Supabase connection (DATABASE_URL, SUPABASE_URL, keys)
...
2. **Database:** Upgrade Supabase tier (Pro plan for connection pooling)
...
- [ ] Database backups enabled in Supabase (automatic on paid plans)
