"""Database service for EduChat - MongoDB integration.

This module provides a comprehensive interface to MongoDB for all database operations.
It implements connection pooling, CRUD operations, and query methods for all collections.
...
class DatabaseService:
    """MongoDB database service with connection pooling and CRUD operations."""
    ...
    def __init__(
        ...
        self.onboarding_questions = self.db["onboarding_questions"]
        self.onboarding_answers = self.db["onboarding_answers"]
