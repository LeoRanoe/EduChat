...
def authenticated_chat() -> rx.Component:
    ...
    return rx.box(
        ...
        toast_notification(
            ...
            on_close=AuthState.hide_toast,
        ),
        
        # Guest banner (shown only for guest users who haven't dismissed it)
        rx.cond(
            AppState.is_guest & ~AppState.is_authenticated & ~AuthState.guest_banner_dismissed,
            guest_banner(),
        ),
            ...
            rx.box(
                ...
                rx.box(
                    ...
                    _hover={
                        ...
                        "box_shadow": "0 4px 8px rgba(220, 38, 38, 0.2)",
                    },
                    _active={
